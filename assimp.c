...
void assimpDrawScene(void) {
  ...
  tmp = 1.0f / tmp;
  gl4duScalef(tmp*5, tmp*5, tmp*5);
gl4duTranslatef(-_scene_center.x, 3,-_scene_center.z);
...
void assimpDrawScene2(void) {
  ...
  tmp = 1.0f / tmp;
  gl4duScalef(tmp*5, tmp*5, tmp*5);
gl4duTranslatef(-_scene_center.x+13, 3,-_scene_center.z);
  sceneDrawVAOs(_scene, _scene->mRootNode, &ivao);
...
void assimpDrawScene3(void) {
  ...
  tmp = 1.0f / tmp;
  gl4duScalef(tmp*5, tmp*5, tmp*5);
gl4duTranslatef(-_scene_center.x, 0,-_scene_center.z);
  sceneDrawVAOs(_scene, _scene->mRootNode, &ivao);
